          ...
          <Form size={50} onSubmit={handleAffectationSubmit}>
            <FormField label="Entité" required>
              ...
              >
                ...
                {entites.map(entite => (
                  <option key={entite.id} value={entite.id}>{entite.code} - {entite.libelle}</option>
                ))}
              </select>
            </FormField>
            ...
            <FormField label="Coût d'affectation" required>
              <FormInput
                type="number"
            ...
            <FormActions>
              <Button
                type="submit"
                label={editingAffectation ? "Modifier l'affectation" : "Créer l'affectation"}
                color={theme.colors.primary}
              />
              <Button
                type="button"
