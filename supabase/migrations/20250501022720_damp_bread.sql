/*
  # Modification des champs de la table fin_bq_format_import

  1. Modifications
    - Augmentation de la taille du champ `separateur` à 10 caractères
    - Ajout d'un champ `commentaires` de 40 caractères

  2. Description
    Cette migration modifie la structure de la table fin_bq_format_import pour
    permettre des séparateurs plus longs et ajouter un champ de commentaires.
*/
